      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-24">
        <div className="flex flex-col items-center space-y-16 text-center">
          ...
          <Link
            ...
            className="group relative overflow-hidden inline-flex h-14 items-center justify-center rounded-full bg-[#9A6B5D] px-12 text-lg font-medium text-white transition-all duration-300 hover:bg-[#7D574B] focus:outline-none focus:ring-2 focus:ring-[#9A6B5D] focus:ring-offset-2"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-lg mb-16">
            {[
              ...
              <div
                key={i}
                className="flex flex-col items-center space-y-4 p-8 bg-white/70 backdrop-blur-sm rounded-3xl shadow-sm hover:shadow-md transition-all duration-300 border border-[#E8B4A4]/20"
              >
